/*
* Filename: HealthCheese.cs
* Developer: Sophia Sivula
* Purpose: This file applies attribute to the HealthCheese
*/
...
/*
* Summary: subclass of ItemClass for HealthCheese
* Member Variables: 
...
*/
public class HealthCheese : ItemClass
{
...
*/
    public HealthCheese()
    {
        ...
        subTempSpeed = (-1, -1); 
        subSpriteImage = Resources.Load<Sprite>("Items Pack/Pixel Art Icon Pack - RPG/Texture/Food/Cheese.png");
