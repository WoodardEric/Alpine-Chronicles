...
public class SpeedPotion : ItemClass
{
    ...
    public SpeedPotion()
    {
        _itemName = "SpeedPotion";
        _strength = -1;
        _health = -1; // error state, if the thing doesnt change it
        _tempStrength = (-1, -1);
        _tempSpeed = (10, 60); //if speed, first number is increase by how much, and second is for how long in seconds
        _spriteImage = Resources.Load<Sprite>("Items Pack/Pixel Art Icon Pack - RPG/Texture/Potion/Red Potion 2.png");
