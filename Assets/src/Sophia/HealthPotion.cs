/*
* Filename: HealthPotion.cs
* Developer: Sophia Sivula
* Purpose: This file applies attribute to the HealthPotion
*/
...
/*
* Summary: subclass of ItemClass for HealthPotion
* Member Variables: 
...
*/
    public HealthPotion()
    {
        ...
        subTempSpeed = (-1, -1);
        subSpriteImage = Resources.Load<Sprite>("Items Pack/Pixel Art Icon Pack - RPG/Texture/Potion/Blue Potion 2.png");
